...
static int (*iceberg_scan_init_stream_func)(IcebergScan*, IcebergResponse*, const void*) = NULL;
...
static int load_iceberg_library(const char* library_path) {
    ...
    iceberg_scan_init_stream_func = (int (*)(IcebergScan*, IcebergResponse*, const void*))dlsym(lib_handle, "iceberg_scan_init_stream");
